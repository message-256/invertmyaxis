...
with that sed i needed a script to invert my z axis in gcode files before running them (my z axis is somehow reversed and i didnt feel like messing with grbl)\
